...
namespace TrainMaster.Application.Services
{
    public class HistoryPasswordService : IHistoryPasswordService
    {
        ...
        public async Task<Result<HistoryPasswordEntity>> UpdateOldPassword(HistoryPasswordEntity historyPasswordEntity)
        {
            using var transaction = _repositoryUoW.BeginTransaction();
            try
            {
                var historyPassById = await _repositoryUoW.HistoryPasswordRepository.GetById(historyPasswordEntity.Id);
                ...
                historyPassById.OldPassword = historyPasswordEntity.OldPassword;
