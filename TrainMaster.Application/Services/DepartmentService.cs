    ...
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<Result<DepartmentEntity>> Add(DepartmentEntity departmentEntity)
        {
            ...
            try
            {
                ...
                var checkNameIsExist = await _repositoryUoW.DepartmentRepository.GetByName(departmentEntity.Name.Value);
        ...
        public async Task<Result<DepartmentEntity>> GetById(int id)
        {
            ...
            try
            {
                ...
                if (result == null)
                    return Result<DepartmentEntity>.Error("departamento não encontrado");
            ...
            {
                transaction.Rollback();
                throw new InvalidOperationException("Erro ao buscar departamento por ID", ex);
            }
            finally
            {
                transaction.Dispose();
